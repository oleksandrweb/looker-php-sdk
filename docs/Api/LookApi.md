...
# **searchLooks**
> \Swagger\Client\Model\Look[] searchLooks($id, $title, $description, $content_favorite_id, $space_id, $user_id, $view_count, $deleted, $query_id, $curate, $fields, $page, $per_page, $sorts, $filter_or)
...
try {
    $result = $apiInstance->searchLooks($id, $title, $description, $content_favorite_id, $space_id, $user_id, $view_count, $deleted, $query_id, $curate, $fields, $page, $per_page, $sorts, $filter_or);
    print_r($result);
} catch (Exception $e) {
