...
### Get information about all spaces.  In API 3.x, this will not return empty personal spaces, unless they belong to the calling user, or if they contain soft-deleted content.  In API 4.0+, all personal spaces will be returned.
...
$body = new \Swagger\Client\Model\CreateSpace(); // \Swagger\Client\Model\CreateSpace | Create a new space
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\CreateSpace**](../Model/CreateSpace.md)| Create a new space |
...
# **searchSpaces**
> \Swagger\Client\Model\Space[] searchSpaces($fields, $page, $per_page, $limit, $offset, $sorts, $name, $id, $parent_id, $creator_id, $filter_or, $is_shared_root)
...
try {
    $result = $apiInstance->searchSpaces($fields, $page, $per_page, $limit, $offset, $sorts, $name, $id, $parent_id, $creator_id, $filter_or, $is_shared_root);
    print_r($result);
} catch (Exception $e) {
...
$space_id = "space_id_example"; // string | Id of space
$body = new \Swagger\Client\Model\UpdateSpace(); // \Swagger\Client\Model\UpdateSpace | Space parameters
...
------------- | ------------- | ------------- | -------------
 **space_id** | **string**| Id of space |
 **body** | [**\Swagger\Client\Model\UpdateSpace**](../Model/UpdateSpace.md)| Space parameters |
