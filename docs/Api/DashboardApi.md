...
try {
    $result = $apiInstance->searchDashboards($id, $slug, $title, $description, $content_favorite_id, $space_id, $folder_id, $deleted, $user_id, $view_count, $content_metadata_id, $curate, $fields, $page, $per_page, $sorts, $filter_or);
    print_r($result);
} catch (Exception $e) {
