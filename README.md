...
***There is also an advanced Looker PHP SDK that will be available soon. It will add extra 
functionality on top of this generated SDK for ease of use like a simplified login process, 
automatic access token renewal, etc. It is currently in development. A link to that package will be 
added here when it is ready.***
